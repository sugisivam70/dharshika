...
const dahrshikaGallery = [
  {
    ...
    description:
      "Custom-fabricated assembly designed for dimensional stability and long production life.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.26.00 PM.jpeg",
    title: "Sheet Metal Execution",
    description:
      "Precision cutting, bending, and fit-up workflow handled with controlled process checks.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.26.10 PM.jpeg",
    title: "Machine Support Fabrication",
    description:
      "Heavy and medium fabrication support for load-bearing machine and utility structures.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.26.18 PM.jpeg",
    title: "Welded Structural Unit",
    description:
      "Strong welded joints and clean finishing prepared for dependable shop-floor operation.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.26.26 PM.jpeg",
    title: "Process Equipment Frame",
    description:
      "Fabricated frame engineered for easy installation, maintenance access, and durability.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.26.54 PM.jpeg",
    title: "Production-Ready Fabrication",
    description:
      "Component manufactured with close attention to drawing intent and repeatable output quality.",
  },

  {
    ...
    description:
      "Finalized unit prepared for delivery after dimensional and workmanship validation.",
  },
  {
    image: "/dahrshika-img/WhatsApp Image 2026-04-02 at 12.31.52 PM.jpeg",
    title: "Custom Project Finish",
    description:
      "Finished custom job supporting industrial operations with reliable structural performance.",
  },
];
    ...
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white space-y-6 fade-in-up">
              ...
              <p className="text-xl md:text-2xl text-white/90 max-w-xl">
                Precision heavy and medium fabrication for industrial projects
                and custom assemblies.
              </p>
              <p className="text-base md:text-lg text-white/80 max-w-xl leading-relaxed">
                From drawing review to dispatch, we deliver reliable, on-time
                fabrication support.
              </p>
              <div className="flex flex-wrap gap-3">
                {["ISO 9001:2015 QMS", "10,000 Sq. Ft. Facility"].map(
                  (item) => (
                    <span
                      key={item}
                      className="px-4 py-2 rounded-full bg-white/15 border border-white/30 text-sm font-medium"
                    >
                      {item}
                    </span>
                  ),
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link
                  to="/services"
                  className="bg-white text-primary hover:bg-gray-100 font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center gap-2"
                >
                  View Services
                  <ArrowRight size={20} />
                </Link>
                <Link
                  to="/contact"
                  className="inline-flex items-center border-2 border-white/90 bg-primary-dark/60 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:bg-primary-dark/80 hover:shadow-2xl backdrop-blur-sm"
                >
                  Get a Quote
                </Link>
              </div>
            ...
            <div className="relative scale-in">
              <div className="relative w-full max-w-md mx-auto">
                ...
                <div className="relative aspect-square rounded-full overflow-hidden border-8 border-white/30 shadow-2xl transform hover:scale-105 transition-transform duration-500">
                  <img
                    src="https://alllandpipes.com/wp-content/uploads/2025/11/Low-Carbon-Steel-Pipe-Properties-Welding-Guide.webp"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="section-title">
              Welcome to <span className="text-primary">Darshika Fab Tech</span>
            </h2>
            <div className="h-1 w-24 bg-primary rounded mx-auto mb-6"></div>
            <p className="section-subtitle">
              Your trusted partner for industrial fabrication and engineered
              metal solutions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 fade-in-up">
              ...
              <p className="text-gray-600">
                High-accuracy sheet metal and structural fabrication built for
            ...
            <div className="text-center p-8 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 fade-in-up">
              ...
              <p className="text-gray-600">
                Fabrication tailored to drawings, load conditions, and
            ...
            <div className="text-center p-8 bg-white rounded-xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 fade-in-up">
              ...
              <p className="text-gray-600">
                End-to-end support from costing and production planning to
      ...
      <section className="py-20 gradient-light">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="section-title">
              Why Choose <span className="text-primary">Darshika Fab Tech</span>
            </h2>
            <div className="h-1 w-24 bg-primary rounded mx-auto mb-6"></div>
            <p className="section-subtitle">
              ISO-aligned fabrication partner with deep process control and
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="space-y-6 slide-in-left">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                We undertake both mild steel and stainless-steel jobs including
                bases, ricer blocks, brackets, machine enclosures, cabinets,
                ducts, casings, tanks, and machine columns.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Our team supports industrial engineering fabrication with strong
                planning, quality checks, preventive maintenance, and process
            ...
            <div className="grid grid-cols-2 gap-4 slide-in-right">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-gray-600">
                  Process-led production methods designed for efficient output
                  and reduced waste
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-gray-600">
                  Fabrication strength that supports heavy-duty industrial
                  operations
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-gray-600">
                  ISO 9001:2015 quality management system implementation in core
                  operations
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                ...
                <p className="text-sm text-gray-600">
                  Drawing-based fabrication with engineering review and
        ...
        <div className="container-custom">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 slide-in-right">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Darshika Fab Tech operates from Peenya Industrial Area,
                Bengaluru, with a total working space of around 10,000 sq. ft.
                built to support inspection, fabrication, raw material storage,
                and controlled process flow.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                From drawing study and costing to in-process checks and final
                inspection, every job is monitored for quality, dimensional
                accuracy, and timely delivery.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Our team also supports production planning, material
                coordination, and process documentation so customers get
                predictable lead times and consistent output quality across
                repeat orders.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                We focus on practical manufacturing results: controlled
                workmanship, traceable stages, and clear communication at every
                checkpoint from project kickoff to final handover.
              </p>
      ...
      <section className="py-20 gradient-light">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="section-title">
              Dahrshika <span className="text-primary">Infrastructure</span>
            </h2>
            <div className="h-1 w-24 bg-primary rounded mx-auto mb-6"></div>
            <p className="section-subtitle max-w-4xl mx-auto">
              A complete visual showcase of our infrastructure, highlighting
              real fabrication outputs across structural builds, custom
              assemblies, process units, and dispatch-ready jobs.
            </p>
          </div>
